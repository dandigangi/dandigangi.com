...
const filled = (path: string) =>
  function Icon({ size = 19, className }: IconProps) {
    return (
      <svg
        width={size}
        height={size}
...
const stroked = (children: React.ReactNode) =>
  function Icon({ size = 19, className }: IconProps) {
    return (
      <svg
        width={size}
...
export const XIcon = filled(
  'M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z'
)

export const LinkedInIcon = filled(
...
export const SunIcon = stroked(
  <>
    ...
    <path d="M12 2.4v2.2M12 19.4v2.2M4.2 12H2M22 12h-2.2M6.1 6.1 4.5 4.5M19.5 19.5l-1.6-1.6M17.9 6.1l1.6-1.6M4.5 19.5l1.6-1.6" />
  </>
)

export const MoonIcon = stroked(<path d="M20 14.2A8.2 8.2 0 0 1 9.8 4 8.4 8.4 0 1 0 20 14.2z" />)
