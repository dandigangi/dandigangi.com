...
My main experience is developing full stack **Javascript**, **React**, **CSS**, and **Node**. Currently I'm on the senior engineering management track leading large teams (10-20+ reports) and various disciplines. But! I am into Go, Python, Kotlin, AWS/cloud, DX (developer experience/productivity), and occasionally some poorly written Rust.
