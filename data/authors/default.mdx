...
**Software Engineer**: 20+ years&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;**Engineering Manager**: 7+ years

My main experience is developing full stack **Node**, **Typescript**, **Javascript**, and my favorite, **React**. But, I do enjoy Go, Python, Kotlin, and occasionally some poorly written Rust. Now a days I work in engineering leadership managing small to large teams of engineers. My skill set shine working within the Product/Design/Engineering triangle with close-to-customer (B2C or B2B) products.

Right now you can find me running all things engineering and then some at [Postmark](https://postmark.com) (under [ActiveCampaign](https://activecampaign.com)).

Companies I've been worked at in the past include **[DocuSign](https://www.docusign.com)**, **[Apartments.com](https://www.apartments.com)**, **[Arrive Logistics](https://arrivelogistics.com)**, and **[OpenLane](https://www.openlane.com)**. Once upon a time I worked at marketing agency completing projects for AT&T, Bosch, H&R Block, and Mazda to name a few.

---

### Experience & Education

**Industries**: Email, Real Estate, Logistics, Legal, Automotive, CRM/Marketing, Finance, Advertising, E-Commerce
...
<strong>Volunteering</strong>: Upright Education, Startup Institute Chicago Teacher (Javascript),
Chicago Javascript Camp Staff, Oral Cancer Foundation

### React Loop Conference

[ReactLoop](https://2019.reactloop.com) is Chicago's only ReactJS conference that a few friends and I organized in 2019. We're looking for new collaborators and partners to bring it back in 2025.
