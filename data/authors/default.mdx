...
My **core mission** is building diverse, high performance teams delivering the best software & experiences. We are customer/experience first thinkers that apply the engineering lense. Our decisions are impactful, needle forward actions pushing us towards success in the now and future.

## Experience

My main experience is developing full stack **Javascript**, **React**, **CSS**, and **Node**. But I do enjoy Go, Python, Kotlin, AWS, DX (developer experience/productivity), and occasionally some poorly written Rust. Now a days I'm on the senior engineering management track leading multiple large teams (5-15+ reports) of various disciplines.

{/* TODO: Markdown target blank not working */}
...
**Industries**: Real Estate, Logistics, Legal, Automotive, CRM/Marketing

**Project Types**: Finance, Accounting, Billing, BI, Data Visualization, ML/AI, Workflow Engines, ReactJS Migrations, Developer Productivity/Tooling, Ecommerce, Advertising, Defect Analysis, Data Ingestion, Realtime & Event Systems, SDLC & Agile, Documentation

**Additional Experience**: Product Management, UX & UI Design, QA
...
<strong>Volunteering</strong>: Startup Institute Chicago Teacher (Javascript), Chicago Javascript Camp Staff, Oral Cancer Foundation
