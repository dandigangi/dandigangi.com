...
My main experience is developing full stack **Javascript**, **React**, and **Node**. Currently I'm on the senior engineering management track leading large teams and various disciplines. But! I am partial to Go, Kotlin, AWS/cloud, DX (developer experience/productivity), and occasionally some poorly written Rust.
...
<strong>Mentoring Platforms</strong>: Private, Plato, MentorCruise

<strong>Volunteering</strong>: Startup Institute Chicago Teacher (Javascript), Chicago Javascript Camp, Oral Cancer Foundation
