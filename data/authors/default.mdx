...
My main experience is developing full stack **Node**, **Typescript**, **Javascript**, **React**, and **CSS**. But I do enjoy Go, Python, Kotlin, AWS, and occasionally some poorly written Rust. Now a days I'm on the engineering management track leading small to large teams ranging from 5-25 engineers of various disciplines.
