...
My **core mission** is building diverse, high performance teams delivering the best experiences. We are customer/experience first thinkers that apply the engineering lense. Our decisions are impactful, needle forward actions pushing us towards success in the now and future.

## Experience

My main experience is developing full stack **Javascript**, **React**, and **Node**. Currently I'm on the senior engineering management track leading large teams and various disciplines. But! I am partial to Go, Kotlin, AWS, DX (developer experience/productivity), and occasionally some poorly written Rust.
...
Coaching and mentoring is a true passion of mine. Spots are available and I'm particularly interested in supporting underserved groups. Previously I've worked with engineers ranging from junior to senior, staff, and even other technical leaders. Product owners and designers are more than welcome also!
