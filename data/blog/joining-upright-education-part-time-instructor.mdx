...
Recently I was invited by Upright Education to sponsor a capstone project for a small team for 4. It's absolutely consumed me the past 3 weeks. The positive kind of consumption. When Paul N., Upright's senior software instructor, reached out an opportunity arose to get backing to what I love at some level.
...
Spending time with the group and each student though my mentor side took over. Lessons ranging from what we do in the industry, how it works, and to how we build good software. I've loved every second and its even re-ignited my passion to code on the side. It's interesting how quickly I began feeling better about my career and myself. In full transparency my depression has had a hold on me for a couple weeks. I couldn't tell you exactly why but my instinct is missing my work and the structure was hurting me more than I realized.
...
**Links**
- [Misc. Code Things Github Repo](https://github.com/dandigangi/misc-code-things)
- [Car Collection HTML/CSS/JS Problem](https://github.com/dandigangi/misc-code-things/tree/main/my-car-collection)
- [Caching Basics w/ Node Example](https://github.com/dandigangi/misc-code-things/blob/main/learn-caching-basics-node-example.js)
- [Regex](https://github.com/dandigangi/misc-code-things/blob/main/regex.md)

If you have any requests, questions, or feedback please hit me up on [Twitter](https://twitter.com/dandigangi) or [dandigangi@proton.me](mailto:dandigangi@proton.me) anytime.