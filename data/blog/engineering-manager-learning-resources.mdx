...
date: '2024-01-30'
lastmod: '2024-01-31'
tags: ['engineering-management', 'leadership', 'management']
draft: false
...
This is the first version so it will be less organized and detailed. You can find the source on my website repo but a <a target="_blank" href="https://github.com/dandigangi/engineering-manager-resources">dedicated repo can be found here</a>. In future updates I'll make specific recommendations and ranking. Maybe a guided plan.

_I cannot vouch for the quality of all of these resources. (<small>**LAST UPDATED**: 1/31/24</small>)_

This was inspired by my friend <a href="https://github.com/ryanburgess/engineer-manager">Ryan Burgess's list</a>. I'm sure there will be crossover but I swear it wasn't stolen. 😝 Make sure to <a href="https://x.com/burgessdryan" target="_blank">follow him on X</a>. Super grateful for all his support.
