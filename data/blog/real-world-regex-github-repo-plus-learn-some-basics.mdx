...
What I do want to share is a learning example along w/ a helpful [Github repository](https://github.com/dandigangi/misc-code-things/blob/main/regex.md). It has real world use cases that I will add as they come up. It's made my life easier and it can help you too. Awareness of how much I used it started to show up when I was managing at [DocuSign](https://docusign.com) and [OpenLane](https://openlane.com) where scale is a thing.
