...
What I do want to share is a learning example along with a helpful [Github repository](https://github.com/dandigangi/misc-code-things). It has real world use cases that I will add as they come up. It's made my life easier and it can help you too. Awareness of how much I used it started to show up when I was managing at [DocuSign](https://docusign.com) and [OpenLane](https://openlane.com) where scale is a thing.

The real world use cases can be found in [regex.md](https://github.com/dandigangi/misc-code-things/blob/main/regex.md)(1).
...
There's an even more ridiculous version here with [RFC 822](https://www.ex-parrot.com/~pdw/Mail-RFC822-Address.html). This is a basic one found in the [Lodash utility library](https://github.com/lodash/lodash/blob/aa18212085c52fc106d075319637b8729e0f179f/src/.internal/unicodeToArray.ts#L30).
...
The example expression we wrote and a detailed explanation is available on [Regex101](https://regex101.com/r/blAEgc/1). I hope you found this helpful and I'll be adding more real world regex work that I do to the [Github repository](https://github.com/dandigangi/misc-code-things).

Absolutely feel free to let me know on [X](https://x.com/dandigangi) or [email](mailto:dandigangi@proton.me) if I got something wrong.
