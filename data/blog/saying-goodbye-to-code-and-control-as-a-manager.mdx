...
**Update**: I joined the Front End Happy Hour (FEHH) podcast recently to discuss this topic in more detail that you can <a href="http://localhost:3000/blog/front-end-happy-hour-podcast-ep134-individual-contributor-to-manager">check out here</a>.
