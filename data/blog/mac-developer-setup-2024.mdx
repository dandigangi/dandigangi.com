...
Change your command line to open previous session path. Example usage is running your server in one tab and then open another to do other things. Commonly I'll do git things in that second tab w/ iTerm.
