...
Keep things simple with Prettier. _Some_ of their styles are not my favorite but overall its a clean configuration by default applied to just about any language. The config below will get everything work right away on save if used after installing their extension.
